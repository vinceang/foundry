#!/bin/bash
# BENT — ship optimized JPEGs from assets-src into public/images.
...
# BENT is a daylight register: the subject's hour is just after sunrise.
# 65 is the floor here; anything below reads as a defect, not a mood.
